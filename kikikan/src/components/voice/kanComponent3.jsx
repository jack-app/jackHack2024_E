...
import VibrationImage3 from './vibrationImage3';
...
const KanComponent = (props) => {
  ...
  return (
    ...
    <div >
      ...
      {volumeData && <VibrationImage3 volumeData={volumeData} filepath={props.img} x={props.x} y={props.y} size={props.size} clearTime={props.clearTime} level={props.level}/>}
    </div>
