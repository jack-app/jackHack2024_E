    ...
    <div className="app">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route activeClassName="active" path="/easygame"element={<EasyGame />}/>
          <Route activeClassName="active" path="/normalgame"element={<NormalGame />}/>
          <Route activeClassName="active" path="/hardgame"element={<HardGame />}/>
          <Route activeClassName="active" path="/clear"element={<GameClear />}/>
        </Routes>
      </BrowserRouter>
    </div>
  );
